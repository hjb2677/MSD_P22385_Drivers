...
Date    : 07/26/2022
Purpose : Header file for error reporter subroutine
"""

# All reports cleared - program can continue running
ERROR_REPORTER_CONTINUE_DRIVER = 6400

# Test Error - A simple code that is used for testing the email functionality and error reporting
